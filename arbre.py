...
from transform import scale, translate, rotate, vec, quaternion, quaternion_from_euler, identity
...
class Tree(Node):
    ...
    def __init__(self, children=(), transform=identity()):
        ...
        # -- For leaf 2
        transform_leaf2 = Node(transform=rotate((0,1,0), phi2)@translate(0,7.5,0), children=[leaf_2])
        
        # -- For leaf 1
        transform_leaf1 = Node(transform=translate(0,7.5,0), children=[leaf_1] )

        # ----------------------- Hierarchy of the tree -------------------------
        leaves = Node(children=[transform_leaf1, transform_leaf2, transform_leaf3, transform_leaf4])
